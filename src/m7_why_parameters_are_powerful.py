...
def run_test_better_draw_circles():
    print()
    print('--------------------------------------------------')
    print('Testing  bettere_draw_circles:  See graphics window')
    print('--------------------------------------------------')
...
def run_test_even_better_draw_circles():
    ...
    #Test 1:
    even_better_draw_circles(10, 15, 'blue')

    #Test 2:
    even_better_draw_circles(20, 2, 'green')

    #Test 2:
    even_better_draw_circles(5, 30, 'purple')


def even_better_draw_circles(circles, radii, color):
    window = rg.RoseWindow(400, 400)
